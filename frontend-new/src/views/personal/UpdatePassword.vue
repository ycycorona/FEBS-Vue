    ...
    >
      <a-form>
        <a-form-item
          ...
          :field-decorator-options="{rules: [{ required: true, message: '请输入旧密码'}, { validator: handleOldPassowrd }], validateTrigger: ['blur']}"
        >
          <a-input
            v-model="oldPassword"
            type="password"
        ...
        <a-popover placement="rightTop" trigger="click" :visible="state.passwordLevelChecked">
          ...
          <a-form-item
            ...
            :field-decorator-options="{rules: [{ required: true, message: '至少6位密码，区分大小写'}, { validator: handlePasswordLevel }], validateTrigger: ['change', 'blur']}"
          >
            <a-input
              v-model="newPassword"
              type="password"
        ...
        <a-form-item
          ...
          :field-decorator-options="{rules: [{ required: true, message: '至少6位密码，区分大小写' }, { validator: handlePasswordCheck }], validateTrigger: ['change', 'blur']}"
        >
          <a-input type="password" autocomplete="false" placeholder="确认密码" />
        </a-form-item>
      </a-form>
    </a-modal>
  </div>
