  ...
  >
    <a-form :form="form">
      ...
      <a-form-item
        ...
        :help="help"
      >
        <a-input v-decorator="['cronExpression']" @blur="checkCron">
...
export default {
  ...
  methods: {
    ...
    setFormValues({ ...job }) {
      ...
      const fields = ['beanName', 'methodName', 'params', 'cronExpression', 'remark']
    ...
    handleSubmit() {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          const job = this.form.getFieldsValue()
    ...
    checkCron() {
      const cron = this.form.getFieldValue('cronExpression')
      if (cron.length) {
