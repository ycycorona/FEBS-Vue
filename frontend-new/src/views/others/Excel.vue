  ...
  <div style="width: 100%">
    <div class="option-area">
      ...
      <div class="button-area">
        <a-button type="primary" style="margin-right: .5rem" @click="downloadTemplate">
          模板下载
        </a-button>
        <a-button style="margin-right: .5rem" @click="exportExcel">
          导出Excel
        </a-button>
        <a-button
    ...
    <import-result
      ...
      :errors="errors"
      :times="times"
      :import-result-visible="importResultVisible"
      @close="handleClose"
    />
  </div>
</template>
...
<style lang="less" scoped>
  @import "~@/assets/style/less/Common";
  .option-area {
