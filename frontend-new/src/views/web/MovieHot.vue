<template>
  <a-skeleton active :loading="loading" :paragraph="{rows: 24}">
    <div style="padding: 10px;">
      <a-row>
        <a-col v-for="(movie, index) in movies" :key="index" :span="span" style="padding: 1rem;">
          <a-card class="movie-card" style="width: 200px" @click="detail(movie.id)">
            ...
            <div class="movie-desc">
              ...
              <div class="movie-score" style="margin-bottom: .5rem">
                <a-rate v-if="movie.r < 1" :default-value="0.5" allow-half disabled />
                <a-rate v-else-if="movie.r < 2" :default-value="1" allow-half disabled />
                <a-rate v-else-if="movie.r < 3" :default-value="1.5" allow-half disabled />
                <a-rate v-else-if="movie.r < 4" :default-value="2" allow-half disabled />
                <a-rate v-else-if="movie.r < 5" :default-value="2.5" allow-half disabled />
                <a-rate v-else-if="movie.r < 6" :default-value="3" allow-half disabled />
                <a-rate v-else-if="movie.r < 7" :default-value="3.5" allow-half disabled />
                <a-rate v-else-if="movie.r < 8" :default-value="4" allow-half disabled />
                <a-rate v-else-if="movie.r < 9" :default-value="4.5" allow-half disabled />
                <a-rate v-else-if="movie.r < 10" :default-value="5" allow-half disabled />
                <a-rate v-else :default-value="0" allow-half disabled />
      ...
      <a-modal
        ...
        @cancel="detailClose"
      >
        <a-tabs ref="movieTabs" :active-key="activeKey" @change="changeTab">
          <a-tab-pane key="1" tab="电影详情">
